#!/bin/bash
	...
	BuildNo=$2
      ...
      (
	   ...
	   make CC=/home/build/ofi-Install/libfabric/$PRNUM/$BuildNo/shmem/bin/oshcc LDLIBS=-lm
      )
      #build PRK 
      (
	   ...
	   echo -e 'SHMEMCC=/home/build/ofi-Install/libfabric/$PRNUM/$BuildNo/shmem/bin/oshcc -std=c99\nSHMEMTOP=/home/build/ofi-Install/libfabric/$PRNUM/$BuildNo/shmem/SOS\n' > common/make.defs
	   make allshmem
      )
     #build test-uh
      (
