...
for idx,mpi in enumerate(mpilist):
    ...
    if (test == "IMB"):
        imb_test = tests.mpitest_imb(branchname=brname,buildno=bno,\
    ...
    if (test == "stress"):
        stress_test = tests.mpitest_stress(branchname=brname,buildno=bno,\
    ...
    if (test =="osu_test"):
        osu_test = tests.mpitest_osu(branchname=brname, buildno=bno,\
