#!/bin/bash
	...
	( 
        ...
        ./autogen.sh
        ./configure --prefix=/home/build/ofi-Install/libfabric/$BranchName/$BuildNo/shmem --disable-fortran --enable-remote-virtual-addressing --disable-aslr-check --enable-pmi-simple --with-ofi=/home/build/ofi-Install/libfabric/$BranchName/$BuildNo LDFLAGS="-fno-pie"
       make -j4
        make check TESTS=
        make install
      )
