...
#build mpi stress test with Intel MPI
    (
         ...
         /home/build/intel/impi_2019.0.5/intel64/bin/mpicc -lz /home/build/scm/wfr-mpi-tests/mpi_stress/mpi_stress.c \
...
#build osu benchmarks with Intel MPI
   (
		...
		export CC=/home/build/intel/impi_2019.0.5/intel64/bin/mpicc
		export CXX=/home/build/intel/impi_2019.0.5/intel64/bin/mpicxx
